...
internal class AuthorService(BookManagerDbContext context, IAuthorByIdDataLoader authorByIdDataLoader, IAuthorByBookIdDataLoader authorByBookIdDataLoader) : IAuthorService
{
    ...
    public Task<Author?> GetAuthorByBookIdAsync(Guid bookId, CancellationToken cancellationToken) =>
        authorByBookIdDataLoader.LoadAsync(bookId, cancellationToken);
}